...
# last review on 2024-03-22 by RAG
...
# (F)
    ...
    ggplot(data = transition_df, aes(x = Var2, y = Var1, fill = Freq)) +
      ...
      scale_fill_gradient(low = "white", high = farbe2) +
    ...
    ggsave("ana2a-BG-heatmap_LVBQ-minor-480dpi.png", plot = last_plot(), path = "Ergebnisse/In-Skript", width = 8, height = 8, dpi = 480)
