...
write.table(B_proben_entr_df, "B-inv-maj.tsv", sep = "\t", row.names = FALSE)
...
#   title = "Entropie zufälliger Stichproben",
  ...
  theme(
    ...
    plot.margin=margin(15, 5, 5, 0, "pt") #t,r,b,l
...
ggsave("entropy_final_inversion-480dpi-major-final.png", plot = last_plot(), width = 4.5, height = 8, dpi = 480)
