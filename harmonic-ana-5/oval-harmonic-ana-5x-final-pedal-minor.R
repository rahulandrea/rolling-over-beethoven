# harmonic-ana-5x-final-pedal: Mittlere Entropie zufälliger Stichproben (Häufigkeitsgewichtet)
# verglichen mit der mittleren Entropie der Akkorde mit Pedal
...
# Pedal bedeutet: Eintrag in oval_harmonic_tab$pedal
# Prüfe vers. mögliche Einträge in Zeile: oval_harmonic_tab$pedal
# > print(unique(oval_harmonic_tab$pedal))
# [Ausgabe:] ""      "V"     "i"     NA      "I"     "IV"    "VI"    "V/VII" "iv"    "bII"   "V/bII"
# dh. Einträge "" und NA sollen ignoriert werden
# !is.na(oval_harmonic_tab$pedal) && oval_harmonic_tab$pedal != ""
...
write.table(B_proben_entr_df, "B-ped-min.tsv", sep = "\t", row.names = FALSE)
...
print("Mittel der Entropien der Akkorde in Moll-Abschnitten mit Pedal:")
print(A_entropy_mean)

# Speichere das Diagramm als PNG-Datei
# ggsave("entropy_final_pedal-480dpi-minor.png", plot = last_plot(), width = 8, height = 8, dpi = 480)
