...
write.table(B_proben_entr_df, "B-ped-maj.tsv", sep = "\t", row.names = FALSE)
...
print("Mittel der Entropien der Akkorde mit Pedal:")
print(A_entropy_mean)

# Speichere das Diagramm als PNG-Datei
# ggsave("entropy_final_pedal-480dpi-major.png", plot = last_plot(), width = 8, height = 8, dpi = 480)
