...
ggplot(chord_freq_df, aes(x = rank, y = relative_frequency)) +
  ...
  annotate(geom="text", x=110, y=0.07, label=paste("R^2 =",round(r_squared, 4)),size=5) +
...
ggsave("rank_vs_freq_zipf_oval-480dpi-2.png", plot = last_plot(), width = 8, height = 4, dpi = 480)