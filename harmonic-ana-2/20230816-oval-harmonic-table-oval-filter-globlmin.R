# Mit "globalkey_is_minor == 1" Filter
...
# Nur Einträge wo "globalkey_is_minor" == 1

final_combined_data_maj <- subset(final_combined_data, globalkey_is_minor == 1)

# Speichere die kombinierte Tabelle in einer Datei
write.table(final_combined_data_maj, "combined_data-oval-filter-min.tsv", sep = "\t", row.names = FALSE, quote = FALSE, na = "")
